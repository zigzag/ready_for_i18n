...
# TextExtractor will scan all text node in you HTML document, extract them and replace with <%=t :key%>

# LabelExtractor will scan all the text related helper methods like link_to('Login'...) and replace with t(:login)
